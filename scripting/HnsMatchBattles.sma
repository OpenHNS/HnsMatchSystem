...
InitCmds() {
    register_clcmd("say /race", "CmdStartRace");
    register_clcmd("racemenu", "CmdStartRace");

    register_clcmd("say /stoprace", "CmdStopRace");
    register_clcmd("stoprace", "CmdStopRace");

    register_clcmd("say /arenas", "CmdArenas");
    register_clcmd("arenasmenu", "CmdArenas");
}
